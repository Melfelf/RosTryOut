...
: ${AMENT_CURRENT_PREFIX:="/workspaces/RosTryOut/src/install/voice_command_node"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/voice_command_node/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/voice_command_node/environment/path.sh"
