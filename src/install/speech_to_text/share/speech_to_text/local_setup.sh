...
: ${AMENT_CURRENT_PREFIX:="/workspaces/RosTryOut/src/install/speech_to_text"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/speech_to_text/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/speech_to_text/environment/path.sh"
